...
<div class="col">
  <div>
        ...
        @endif
      <form method="post" action="{{ route('customers.tasks.update', $taskNotes->id) }}">
            @method('PATCH')
          @csrf
          <div class="form-group">
              <label for="description">Task ID:</label>
              <input type="text" class="form-control" name="description" value={{ $taskNotes->id }} readonly/>
          </div>

          <div class="form-group">
              <label for="description">Description:</label>
              <input type="text" class="form-control" name="description" value={{ $taskNotes->description }} />
          </div>

          <div class="form-group">
              <label for="Todo_Due_Date">Todo Due Date:</label>
              <input type="text" class="form-control" name="Todo_Due_Date" value={{ $taskNotes->Todo_Due_Date }} />
          </div> 

          <div class="form-group">
              <label for="Task_Status">Status:</label>
              <select class="form-control" name="Task_Status">
                            <option value={{ $taskNotes->Task_Status }}>Pending</option> 
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" name="Task_Update" value={{ $taskNotes->Task_Update }} />
          </div>
          <div class="form-group">
              <label for="Sales_Rep">Handler:</label>
              <input type="text" class="form-control" name="Sales_Rep" value={{ $taskNotes->Sales_Rep }} />
          </div>
