...
CREATE TABLE `notes` (
  ...
  `Task_Update` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  CONSTRAINT `fk_cus_id` FOREIGN KEY (`cus_id`) REFERENCES `contacts` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2019-09-27  8:59:48
